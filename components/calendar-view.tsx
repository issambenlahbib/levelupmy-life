...
<Dialog open={!!selectedDate} onOpenChange={() => setSelectedDate(null)}>
  <DialogContent className="w-full max-w-[95%] max-h-[80vh] overflow-y-auto">
    <DialogHeader>
        ...
        <Card className="bg-white border border-slate-300">
          ...
          <CardContent>
            <div className="w-full">
              {/* Hour headers */}
              <div className="grid grid-cols-[1fr_repeat(24,minmax(0,1fr))] gap-[1px] bg-slate-200 text-xs font-bold text-slate-700 mb-2">
                <div className="text-left p-2 bg-white">Tasks</div>
                {hours.map((hour) => (
                  <div key={hour} className="text-center p-2 bg-white">
              ...
              {getTasksForDate(selectedDate).map((task) => (
                <div
                  key={task.id}
                  className="grid grid-cols-[1fr_repeat(24,minmax(0,1fr))] gap-[1px] items-center"
                >
                  ...
                  {hours.map((hour) => {
                    ...
                    return (
                      <div
                        key={hour}
                        className={`h-8 text-center border border-slate-200 ${
